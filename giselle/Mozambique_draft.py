#Mozambique_draft
#$$c(E 30°15'00"--E 36°09'00"/S 13°55'00"--S 26°52'00")
...
#mozambique: #$$c(E 30°15'00"--E 36°09'00"/S 13°55'00"--S 26°52'00")

#did I get coordinates right?
minlat = -30.; maxlat = 13.
minlon = 26; maxlon = 55.
mozam =  chirps.sel(latitude=slice(minlat,maxlat),longitude=slice(minlon,maxlon))
#congo.load()
mozam.precip[0,:,:].plot.pcolormesh()
